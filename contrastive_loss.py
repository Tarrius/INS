...
class SupConLoss(nn.Module):
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        #top_values, top_indices = torch.topk(labels, k=4)
        top_values, top_indices = torch.topk(labels, k=2)
        #top_values, top_indices = torch.topk(labels, k=1)
        
        prediction1 = top_indices[:, 0]
        prediction2 = top_indices[:, 1]
        #prediction3 = top_indices[:, 2]
        #prediction4 = top_indices[:, 3]
        ...
        #temp = (mask==mask2)&(mask==mask3)&(mask==mask4)&(mask2==mask3)&(mask2==mask4)&(mask3==mask4)
        temp = (mask==mask2)
        temp = temp.float()
